...
## [3.37.0](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/compare/v3.36.1...v3.37.0) (2026-03-20)


### New Features

* account linking and merge system for cabinet ([dc7b8dc](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/dc7b8dc72a3a398d6270a0a2b8ce9e2b54cb9af7))
* account merge system — atomic user merge with full FK coverage ([2664b49](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/2664b4956d8436a2720d7cd5992b8cdbb72cdbd9))
* add _calculate_servers_price (fixed fallback) and _calculate_traffic_price ([88369ee](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/88369eec5047e733d26d2450a74abd0d600b2e1b))
* add admin topic notifications for landing page purchases ([dbb9757](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/dbb9757a3c7938ab7505358942f675b82401245a))
* add cabinet gift subscription API routes and schemas ([6a61b09](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/6a61b095755885ff8973eb9ac4422740d07e0306))
* add cabinet menu layout editor with row arrangement, custom URL buttons, and drag-and-drop reordering ([dd8d7f6](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/dd8d7f69203490553d15dcdad6dda28fab02d593))
* add CABINET_GIFT_ENABLED branding toggle ([759bfe1](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/759bfe1bdb3a3d3f917334fd32d0ea2f5be5d1f0))
* add CLASSIC_PERIOD_PRICES to config ([c3bb63f](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/c3bb63ffed6e0b684c322aa51d70ab7e71c8eb6b))
* add configurable animated background for landing pages ([11d3e63](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/11d3e637c106590a73ed804fc762bf303b37dd62))
* add dedicated sales_stats RBAC permission section ([8f29e2e](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/8f29e2eee2e0c78f7f7e87a322eaf4bd4221069c))
* add discount system for landing pages ([aa7d986](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/aa7d98630dd9be2cfb81dac3ef2c1c6730487e61))
* add external squad support for tariffs ([c10d678](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/c10d6780ba89ac641769dcb0c4ab2d89f124f0b7))
* add GET /admin/rbac/users endpoint for listing all RBAC users ([8b77cda](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/8b77cdae2ccc489bfead89523f31cd15bfdc675b))
* add gifts section to admin user detail API ([bca8bab](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/bca8bab4336b2583da9be8c642985e6a0151e33d))
* add landing page statistics endpoint with charts data ([25478ce](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/25478ced209fdbf12f2c398ad1c8d48ac26c923e))
* add landings to permission registry ([c93dbec](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/c93dbec7a0e24a6cc41449ed3c6e5fb669b127a9))
* add LIMITED subscription status and preserve extra devices on tariff switch ([8f43452](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/8f434525eb14618e3c3e26261d443b1632c111bb))
* add media attachment support for admin ticket replies ([69bb399](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/69bb399b63d6e1d761cc5518e6272917fc5a6ae7))
* add multi-provider recovery, retry_count, amount verification, and indexes ([3d78974](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/3d78974af70b360449d9cf634e09a79821cdc7c0))
* add open_in setting for custom buttons (external browser / webapp) ([497a8ee](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/497a8ee5b528cf80d7042a7eec62369b6a327339))
* add paginated purchases list endpoint for landing pages ([0ba1127](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/0ba112746913bb9927338a7554370ac8c4e12039))
* add partner → campaign edges to referral network graph ([01132a7](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/01132a7bc77b07eaaaf876c05d639bfed83e5324))
* add POST /auth/telegram/oidc endpoint for OIDC popup flow ([3a400d9](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/3a400d9f8b3b4dd2c0bb12fc68f1af6e7c880761))
* add promo group and promo offer discounts to gift subscriptions ([2fd0f6a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/2fd0f6aa4eb62f704208c1e56a6542d3967e7867))
* add quick purchase email templates to admin panel ([6970340](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/6970340e62c67a41f3219759fb0a752617690ea0))
* add referral network graph visualization admin API ([c08c903](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/c08c903e8f94f3730872b19de904ce166ba35b98))
* add RenewalPricing dataclass and PricingEngine discount methods ([83ca51c](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/83ca51cd5b040e747c6db904dde0f3a5c59f480f))
* add SBP and Card sub-options for KassaAI payment method ([5b722c5](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/5b722c521036befcbbaf6192215f651c2ec9c4fb))
* add SBP and Card sub-options to kassa_ai payment method ([04419fd](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/04419fdff7dc244eb2c9553ea1501e2de454010b))
* add scoped referral network graph with scope selector API ([df086b0](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/df086b09c75a9157cdc558fb610b617a2d49deaf))
* add server-complete OAuth linking endpoint for Mini App flow ([f867989](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/f867989557d20378cfe815c9c88e1a842c4f6654))
* add show_in_gift toggle for tariffs in admin panel ([cb5126a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/cb5126aff8c15938a59ea9c4f8e605b250b05dbc))
* add source and buyer_user_id fields to GuestPurchase model ([0936d4a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/0936d4a7f651a1fcef8c2f86818320af3764b423))
* add sub_options support for landing page payment methods ([220196f](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/220196fb7abc88b60a37c1fb60786dd3a6ada3ad))
* add sync-squads endpoint for bulk updating subscription squads in Remnawave ([b1e2146](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b1e2146254255586b5be9bd894ac4d113a0a8cf5))
* add Telegram account linking endpoint with security hardening ([da40d56](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/da40d5662d6d064090769823d616d6f9748ab5b9))
* add telegram gift notification with inline activation button ([9ba61a0](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/9ba61a08796fbc06e0dea2ee9cb02edc4126b335))
* add Telegram OIDC id_token validation and code exchange ([2f0a9dc](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/2f0a9dc4f3489f7d4311101191129ee95d7edbcc))
* add TELEGRAM_OIDC_* settings for new Telegram Login ([833df51](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/833df518d010d1bfd773eb0c85aaa7e653c7e153))
* add user_email to admin payments API response ([7101555](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/7101555da0722d1eacd97f40b6b8c8c3a2327a0c))
* auto-resume disabled daily subscriptions on balance topup ([770b31d](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/770b31d3d05c22411b64ddbea3c304e34d879f5b))
* auto-sync squads to Remnawave when admin updates tariff ([076290e](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/076290e0c1d81b610a7653d6b64ed218e0f124b4))
* configurable Telegram Login Widget with admin settings ([084a3cd](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/084a3cd16f8825c389514813ba679748ba235d0a))
* deep link авторизация в кабинете при блокировке oauth.telegram.org ([322d457](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/322d45765220c854e36ae0b4b862a96d36ae3be8))
* expose oidc_enabled and oidc_client_id in telegram-widget config ([000b0c0](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/000b0c0592773d0a5f6f572fd8a721ce0f474b2c))
* expose payment sub-options with labels in public landing API ([c53e9af](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/c53e9af744114e5d6fe014b09b4fac8da1e59c6e))
* gift subscription code-only purchase + activation via deep link ([5ffce17](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/5ffce175dcb8aebf22cf536bfa032c66da284600))
* guest purchase → cabinet account integration ([f8edfd7](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/f8edfd77463aad64d9e616569467b4883be4dccf))
* guest purchase delivery & activation system ([776fc3a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/776fc3aadc14e1cc415286cf008fa4eb85f21164))
* implement calculate_renewal_price with tariff and classic modes ([02e5401](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/02e5401327786c9dfe5ae7d4c89624c9455aa53e))
* implement gateway payment for gifts, persist recipient warning ([cd04f3b](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/cd04f3b622444f45e2edf4a92da581f3d1f79b67))
* include manual admin top-ups in sales statistics revenue ([b80eeea](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b80eeea089568c60c20b1ae165b8dbe887bbe378))
* multi-select scope for referral network graph API ([6a4ce3d](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/6a4ce3dd38dc3cf2e9db08322093bfd0b84f1e1c))
* prevent self-activation of gift codes ([b30c73c](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b30c73c300019646ea4a0d7e1bf758464ee58f0f))
* referral links now point to web cabinet instead of bot ([12ae871](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/12ae871653399bc4ccd23b6394878e814ce9cd75))
* register TELEGRAM_OIDC category, hints in admin settings ([3a36162](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/3a361628aa543cb629d6967d84d7f474b89c3841))
* добавлен SeverPay в админ-панель и настройки кабинета ([06a00e3](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/06a00e367c303b5426008f38a20393ec4f2e07cd))
* добавлена интеграция SeverPay для пополнения баланса ([abaf279](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/abaf279533d31994a8a70346627c962b43000c64))
* добавлена поддержка RioPay в кабинете ([3d1fbc7](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/3d1fbc70f8add81d4a3561d63dcd46f385bcc6f1))
* добавлена поддержка RioPay для лендингов и подарков ([04f4e6b](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/04f4e6bf6e9031ef8512a07ab36355111c524319))
* мультиязычные лендинги + гостевые платежи для всех провайдеров ([6deab7d](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/6deab7dd8c5c5df812bd69608369258a10a67ca4))
* поиск платежей в админ-панели с фильтрами и статистикой ([1804c28](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/1804c28f0551fbe52883fc36fc4cfcd60d2d6bd6))
* публичные лендинг-страницы для быстрой покупки VPN-подписок ([5e404cc](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/5e404cc082859d875f988911fcc4eedaa35b886b))
* раздельные топики для админских уведомлений ([e15b18f](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/e15b18fb41b180e7dd3d65f2f058667be321fe85))


### Bug Fixes

* 3 bugs — notification type, referral with channel sub, BOT_USERNAME ([3c96c2a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/3c96c2affd5a803311e3c0c9a0f844d2217f387a))
* 3 critical issues from second-round review ([a90d2d9](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/a90d2d936793daaadf116cf314b736a9ebfb7c3b))
* abs() for transaction amounts in admin notifications and subscription events ([fd139b2](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/fd139b28a2c45cc3fbd2e01707fb83fbabf57c71))
* add abs() to expenses query, display flip, contest stats, and recent payments ([de6f806](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/de6f80694ba8aa240764e2769ec04c16fe7f3672))
* add activate hint to gift pending activation email link ([fa21549](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/fa21549cac9098f49e2e32868acce461acd1b40d))
* add back button to payment amount validation errors ([20eff61](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/20eff6170fb752051022a14fa9d927d59ff1d602))
* add IntegrityError handling on link commit and format fixes ([0c1dc58](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/0c1dc580c67254d11ffb096c22d8c8d78ac18e2b))
* add Message-ID and Date headers to outgoing emails ([de541ea](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/de541ea1c3fa20c606c0ea1b69a0223569afb9e2))
* add Message-ID and Date headers to outgoing emails ([e9b4d8e](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/e9b4d8e444be9ab666caf642c849dcf63b1884ab))
* add method query param to return_url and latest-payment endpoint ([32d58b0](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/32d58b04b9a37473f43ae07cc32d4e18b161e3b9))
* add minimum 8-char length check for gift token in bot deep link ([8a8337f](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/8a8337f538c3fcaf84b84c34b7a1e38a4ce9d580))
* add missing mark_as_paid_subscription, fix operation order, remove dead code ([5f2d855](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/5f2d855702dea838b38887a5f44b9ad759acd5cf))
* add missing settings import in admin_users tariff switch ([b2ee6c7](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b2ee6c766a1fb0c9a701684a6349b970d12f5e2e))
* add nested selectinload and referrer eager loading to prevent MissingGreenlet ([3306e02](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/3306e029021c396e13774a205225beece4fbbcfb))
* add null check for subscription in execute_change_devices ([5081deb](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/5081debee7625954bd7b82f66e09dd58e08e8822))
* add or [] guard to remaining connected_squads call site in fulfill_purchase ([d9f9f3d](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/d9f9f3dca126963967782160766bd5b26bde7a49))
* add pending_activation to purchase stats and show total count ([8510597](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/8510597ddb501c479d5b70118a94944556ab984f))
* add per-category discounts and months multiplier to classic mode ([1660b24](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/1660b24f9844374bbd156f9202a8e1550a6beb49))
* add period_days whitelist validation and type annotations ([18e2e78](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/18e2e7841a6d614263e7c87db5964916ec869a9d))
* add post_update=True to User.referrals self-referential relationship ([9957259](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/995725988150f31d193631120a4692e88fa4dd57))
* add referral_code pattern validation, email login rate limiting, and Retry-After headers ([5499ad6](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/5499ad62dc98346bef9cb83bf6d8bca319291371))
* add selectinload to user lock queries to prevent MissingGreenlet ([5442f28](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/5442f288d4c6c3973dd92ac141172a9f0e53a28f))
* add sync_squads=True to admin tariff change handler ([3f0b24c](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/3f0b24c1ec82ebfb6fdbc801ed6b493ea09c9a2f))
* add table existence guards to migrations for optional payment tables ([f4a7763](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/f4a776319eaccbce108a1f22462da6cd592fe0f3))
* add Telegram Stars payment support for gift subscriptions ([5424d8c](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/5424d8c31484873b0adc0bc980abdc51ee81325b))
* add X-CSRF-Token and X-Telegram-Init-Data to CORS allow_headers ([77456ef](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/77456efb7504e12c9b9879a352118ce1687132b1))
* address 6-agent review findings for PricingEngine ([c9f2dff](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/c9f2dffabf6369df360c5f9ad7a12c0415026310))
* address code review findings for Telegram OIDC ([da1cc4f](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/da1cc4fe5ab6436210185a12dc2a82cb153fc24a))
* address review findings for guest purchase admin notifications ([770f19e](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/770f19e84688e55ed44f7c9de26b0e9ae9636c4b))
* address review findings for guest purchase recovery ([57c5c67](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/57c5c679eef987e9bacee1a9d420ac3c0ff69ff7))
* address review findings for multi-provider recovery ([79c110f](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/79c110ff41659ff225164c13690bafc859212d05))
* address review findings from 5-agent audit ([08bea70](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/08bea704ded78102dce29deac8da95c4e4b9d815))
* address review findings from 6-agent audit ([5c34656](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/5c3465647639d6f07432bc3d725bba9396af6c45))
* admin tariff server selection - 64-byte overflow and callback routing conflicts ([536525c](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/536525c9c0a7701321bc3b83d6cef125c6f343ba))
* align context_vars and SAMPLE_CONTEXTS with actual runtime context keys ([ab5313a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/ab5313a381f8175346b470d6d1df54d8d7d11ff8))
* align subscription_renewed/activated context_vars with runtime keys ([c507634](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/c507634398d3e934246b2c66183ebad1b9949769))
* align tariff pricing with calculate_renewal_price reference ([6349b2f](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/6349b2f4426abd49e3bd63364f3d2b204a486282))
* allow repeated auto-assignment of promo groups on each purchase ([4a002b7](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/4a002b7db1bfa8fd1149b0e3dfa469e8912a0e3b))
* atomicity refactor, review fixes, and DELETED recovery logging ([ba54819](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/ba54819f9cd7f60914dd472b68885683f435db4e))
* auto-purchase classic extend missing device_limit and traffic_limit_gb ([7dc5e4a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/7dc5e4ab94a415dc739a49c74cde511aad0cbb29))
* auto-update permissions for system roles on bootstrap ([eff74be](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/eff74bed5bcc47a6cfa05c20cad14a40c1572d1f))
* backup restore fails on FK constraints and transaction poisoning ([ff1c872](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/ff1c8722c9188fdbaf765d6b7e9192686df64850))
* campaign registration, revenue calculation, backup restore, autopay errors, referral links ([7648707](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/7648707ca26d6cd2703b50b0fe8c4697e6155784))
* centralize balance deduction and fix unchecked return values ([0466528](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/0466528925a24087b8522a10cbb11c947c2b7d91))
* centralize has_had_paid_subscription into subtract_user_balance ([e4a6aad](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/e4a6aad621be7ef4e7aedb21373927ede0c8d0a5))
* change None assignment to [] + add "or []" guards at all 5 call sites. ([a5fbd74](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/a5fbd7400f828824c5baa520bdaf06023b4caf70))
* clean email verification and password fields from secondary user during merge ([7b4e948](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/7b4e9488f6fbd1271f063579e48ca9a3c96cb645))
* close remaining daily subscription expire paths ([618c936](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/618c936ac9ce4904cd784bf2278d3da188895f2d))
* code style and formatting from review ([a539d69](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/a539d698546a60aa0a06759f91c77476380a20b1))
* code-only gifts skip fulfillment in gateway webhook + retry service ([05bcac5](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/05bcac502efb1b4298a1c6be91bba5d7c057b9f0))
* complete FK migration — add 27 missing constraints, fix broadcast_history nullable ([fe393d2](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/fe393d2ca6ce302d8213cc751842ea92ef277e76))
* comprehensive security and quality fixes from 7-agent review ([5c55662](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/5c55662e2c7068456aeee435b543a851225ff39e))
* comprehensive security hardening from 7-agent review ([e96fe1e](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/e96fe1ecd8d90878a3fbad9ed76c1a2e7f3a1415))
* conditional log messages and sanitize panel_error in user deletion ([289cbe9](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/289cbe966e42afe74c8d1b936139941ff84e008b))
* consume promo offer in miniapp tariff-mode renewal path ([b8857e7](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b8857e789ef60cf0c8766abbeadd094f62070a61))
* consume promo offer in tariff_purchase.py, fix negative transaction amount ([c8ef808](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/c8ef80853915af3e3eb254edd07d8d78b66a9282))
* correct CryptoBot webhook signature verification and auto-fill topup amount from cart ([d7ad9d7](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/d7ad9d70330b6ef5599f7a9409cdd16657d61b85))
* correct device_limit and connected_squads in guest purchase fulfillment ([44d46fe](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/44d46feb0adec9255fbf167e9937ea70b711e289))
* correct revenue calculations in referral network ([c8f4cca](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/c8f4cca34053713eb2793bbb82e74cbb9a6f893c))
* correct RioPay API header case and remove undocumented fields ([1a87d43](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/1a87d438fe127a0b62bd6ee59887212869a3cb17))
* correct skipped_count in sync-squads circuit breaker and simplify ternary ([8a362db](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/8a362db7833b5b7793b5b52345d227cb84cbc39e))
* critical OIDC fixes from 7-agent review ([b78c01c](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b78c01cae9746275057aaf61c0876ccfd72e1f62))
* CryptoBot guest payment — remove is_paid [@property](https://github.com/property) write, use correct status ([6f871ed](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/6f871edc9d01ca20d1b194a157d3d6ae46512d05))
* deep link auth security and reliability fixes ([099391e](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/099391eb5f24319703f12ae2cb72d93b26164d99))
* delete cross-referral earnings before bulk reassignment, clear secondary.referred_by_id ([f204b67](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/f204b678803297ce60faad628d16f46344b11ed0))
* device_limit fallback 1→0 для корректного отображения безлимита ([3e26832](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/3e26832e745368a0dab2617e4e8ae2c410c6bca2))
* disable quick amount buttons in balance topup ([d0eab3f](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/d0eab3f7aacf0249ca244f168c96044347c918e3))
* downgrade known-harmless RemnaWave 400s to warning level ([0419781](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/04197817fede058dc4688dce2f9877f0fc2a7f7f))
* drop legacy prize_days column from contest_templates ([5214f55](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/5214f55f46391c7870a38ea51c2efc2f4e518f58))
* empty JSONB values exported as None in backup ([57aaca8](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/57aaca82f5bf9d7bdd9d4b924aa3412d85eccbb5))
* encode payment status in provider return URLs and wire failed_url ([275f249](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/275f249bbdf28d065e1b856e4d8ec7e73af4e1aa))
* enforce HTTPS for webapp mode, deduplicate keyboard builder, fix long line ([69dbd6a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/69dbd6a2df4cf5e0dd7156ca0f3beb53c4a061af))
* enforce promo group authorization on country/server selection ([641da94](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/641da949a907ade7b870e1a5385fdb71f9e524af))
* enforce tariff device_price and max_device_limit across all purchase paths ([f9f07f3](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/f9f07f360c36ce1eade8a27fa0fa5bf22808db93))
* fix Platega and CryptoBot webhook verification ([b40a812](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b40a812f3aa0596bf6c5105008451dd8a17b103f))
* from redis.exceptions import NoScriptError ([667291a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/667291a2dcaeae21e27eeb6376085e69caa4e45a))
* gift purchase notification and activation flow ([330d1cb](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/330d1cb6fe2eee81a3e8f841de75d41e8b4cde40))
* guard rollback on commit flag, add flush to promo_offer_log ([b7775b7](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b7775b72dc7a1b3d18f179c2f247fe9f47023347))
* handle duplicate admin roles in RBAC bootstrap ([877b1cd](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/877b1cde11c462c0cf5692119ca09944476a2fb6))
* handle duplicate remnawave_uuid on email sync ([eaeee7a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/eaeee7a765c03ff33e2928cdb41be91948eca95c))
* handle expired subscription in guest purchase fulfillment ([9e78509](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/9e785092843cf7f6b3ebb5bfa1710030c74ceafb))
* handle legacy telegram_id in YooKassa webhook recovery metadata ([815a1d9](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/815a1d9136f39b932d4b369aec9d67034d6785d9))
* handle None autopay_days_before in autopayment processing ([f1d4534](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/f1d45343e941594d69f71e822ecc9b3a7062f4bf))
* harden account merge security and correctness ([d855e9e](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/d855e9e47fab1a038e581437a9921bdfeb11e927))
* harden gift subscription feature after multi-agent review ([6a4140e](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/6a4140e3e203beb20cc56aa9c65dfed70f0a12d7))
* harden remnawave API error handling and YooKassa user cross-validation ([585baaf](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/585baaf63c9f535e5311a32085d0187d8c854001))
* harden YooKassa webhook recovery user lookup ([d35ee58](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/d35ee58aa6f3edc6a9e8ab43025569262acf64a2))
* implement case-insensitive email checks in authentication and user retrieval ([7e466ef](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/7e466ef464ce918d885bd6297d1e605a633fd43e))
* implement case-insensitive email checks in authentication and user retrieval ([ebee834](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/ebee8348ca338b9be5f044537e5e2b4740dc6441))
* improve referral network query correctness and cleanup ([ac9fcd8](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/ac9fcd8d30dd64fdc7363e689e9ffaf03700976e))
* invalid ISO date format in node usage stats API call ([69a38da](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/69a38dad259bd05f4658e1014ce0bd73fc2e2ac5))
* keep DB session alive in Tribute payment notification handler ([4186159](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/4186159a61a40003454afc9c0faf848582cfb037))
* latest-payment endpoint returns all payments, not just pending ([7a9264b](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/7a9264b1731cf8935c9e3985f41a1df919dfbf83))
* loyalty tiers current status based on spending, not assigned group ([b815abf](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b815abf2b11e32eb658f9a8a63ae902bc0db46f4))
* make migration 0042 idempotent for retry_count column ([5faf701](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/5faf7015ac043f44366fd2a5e00be19eab76b945))
* make users.promo_group_id nullable — sync DB with model ([e0f2243](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/e0f2243f49ca8cc741a5c07b63ef3eb2abdef52c))
* merge phantom users into active accounts on /start ([77f1a76](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/77f1a764d59d68236899ec59c884907d3666d3dd))
* **merge:** validate before consuming token, add flush, defensive balance ([bc1e6fb](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/bc1e6fb22c6e23c7a34364796f51a55c60224aff))
* migrate pricing to days-based proration, fix promo revenue leaks, fix admin panel bugs ([fcdeff1](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/fcdeff1ee5155c88c634e12a703159c221d66af5))
* MissingGreenlet crash after subscription purchase in cabinet ([a80a85c](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/a80a85c2a489f397efb4ffb5bd77655420a49adb))
* MissingGreenlet crash after subscription purchase in cabinet ([1cc687a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/1cc687ac15ecdf12928e5ce448514c09b6628f65))
* MissingGreenlet on campaign registrations access ([018f18f](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/018f18fa0c9bba1a1dbca8b2398b9611d0c94c36))
* MissingGreenlet при изменении количества устройств на CLASSIC подписках ([826accb](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/826accba519f23a687fcc3d387f727fd31d2a88c))
* multiple payment and notification bugs ([f4eeb9a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/f4eeb9a503d6da8a152f8cb60b89f7ebbdf41c4a))
* negate GIFT_PAYMENT amounts and remove dead code ([f80b058](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/f80b0583804f27c322a4eb27f0613163ca1f97e9))
* negative balance transfer, linking state validation, referrer migration ([531d5cf](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/531d5cff3019e72dde6ee64977cb801e8f8c8d0b))
* normalize threshold 0→NULL in create_promo_group for consistency ([b9089e6](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b9089e693f823e3b8618d08329ccba559592dfa3))
* panel sync now updates end_date in both directions ([def594b](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/def594bbb55ef45d3df81524bd8841de73a07340))
* pass cabinet return_url to payment providers for top-up redirects ([7ca9619](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/7ca96195a7240ce0c3bd613c20344d79e5219c74))
* pass full token to svc_activate instead of truncated prefix ([38c6adf](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/38c6adfdb4d4fc786bf6ca34a5d54025126130c0))
* pass return_url to all payment providers for guest purchases ([b85646a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b85646af85c4b2036f1c07c89e3e282f74d43c1e))
* payment gateway issues — YooKassa polling, PAL24 card 500 ([95a32e8](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/95a32e8574320eeba9276e44551a2f1207ae1e8b))
* payment providers — lock_user_for_update + commit=False atomicity ([b4ef52c](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b4ef52caa4b324eded8e6c6cb715a09ad59140c1))
* **payment:** prioritize saved cart after topup over expired auto-extend ([28321df](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/28321df4d274269536efebcf3da870f2e7d07d90))
* platega webhook ID fallback for SBP and card payments ([aa3459b](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/aa3459b8463ce0a54b7709aa3547b2337064fa26))
* preserve connected_squads during subscription replacement cleanup ([d86c29a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/d86c29a5d384db1d11ef3666153fa288d0c822d8))
* preserve purchased devices when admin changes user tariff ([bf72f24](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/bf72f241d81e4432f50a61ec3bb829d18c92955d))
* prevent account takeover via auto_login_token, ensure promo group on all purchase paths ([b3f3eba](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b3f3eba5756404df9ed0f12d8048244ca536f7d3))
* prevent balance loss on auto-purchase for DISABLED subscriptions and fix WATA expiration ([266340a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/266340aad195995f208ed82fc11e0909d34898f4))
* prevent concurrent device purchases exceeding max device limit ([1cfede2](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/1cfede28b7570bcaf77cb53d6b2a9f3b0e4e9408))
* prevent daily subscriptions from being expired by middleware/CRUD/webhook ([0ed6397](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/0ed6397fa9e5810fcffc9152ab2241fcf37cf85a))
* prevent duplicate promo groups during auto-assignment after purchase ([da7a9cc](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/da7a9cc3c5fd771b932a2bfd154400f6f923a4d1))
* prevent guest purchases from getting stuck in PENDING/FAILED status ([2781236](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/2781236011942e794949544b9c5422aa8679e5eb))
* prevent infinite reuse of first_purchase_only promo code discounts ([2cec8dc](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/2cec8dc4a487017f4b1c5ca80710f2d70045b825))
* prevent premature commits in promocode promo group operations ([8b26680](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/8b2668087b4831c08474846b20591b2158d607fc))
* prevent self-referral loops, invalidate all sessions on merge ([db61365](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/db61365e11ccec4dd45671b33da00f4b05484589))
* pricing audit — display/charge parity, race conditions, balance locks ([ae99358](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/ae99358ae9f35a25370ab127d98a0b630a08e3f2))
* propagate exceptions from get_primary_user_promo_group ([3ec9e71](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/3ec9e71de7d8d40e969f9ea738455445d04d983a))
* propagate tariff squad changes to existing subscriptions and fix user deletion from Remnawave ([7ccfb66](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/7ccfb66690c93df0c9c694935b16a280ca8ae812))
* protect external squads from deletion during server sync ([b563796](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b563796091e83edcc8dfbd6222648b5346f39a9c))
* quick topup buttons include device/server/traffic costs, broadcast button crash on media messages ([5ebe107](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/5ebe1072c9c8a1dcb6ee4cbbea2dc55211b534c4))
* reactivate subscription after traffic top-up when status is EXPIRED ([8b35428](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/8b354280558a5f28d1b99eae55ccd21a4af6a07b))
* read discount overrides from landing model instead of response DTO ([6d65e15](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/6d65e152669a7e92f93f592993c1d5507b890046))
* read OIDC enabled setting from DB in auth endpoint ([2405dc5](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/2405dc5c1b6d6266da373e0e4dac6444b0e70a03))
* reassign orphaned records on merge, eliminate TOCTOU race ([d7a9d2b](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/d7a9d2bfba5b796882d3e04be6038b766cd0a4c8))
* record transactions for free tariff switches and admin tariff changes ([864a4ed](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/864a4ed7005195ff3be3a8bb2e7666bc5a7f3e4e))
* redis cache uses sync client due to import shadowing ([667291a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/667291a2dcaeae21e27eeb6376085e69caa4e45a))
* refresh CLASSIC_PERIOD_PRICES when admin changes PRICE_*_DAYS or SALES_MODE ([6adf70b](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/6adf70b2da6e2250cc8e909dbb497b355302e72f))
* refresh user subscription after gift activation in /start ([363ccce](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/363ccce56d3e61554ca49d725322a79b05bc65d3))
* remaining context_vars/SAMPLE_CONTEXTS mismatches found by agents ([d72ea6b](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/d72ea6b7f999c320038f0327a0c541d1cd276244))
* remove begin_nested that breaks activate_purchase transaction ([0005d59](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/0005d59da1e58c38561c8346db89d8475a25d7df))
* remove contains_eager conflicting with selectinload on user relationship ([fddf8ef](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/fddf8ef5ebc8e5176a75a10e92d59165bdabf2e1))
* remove decorative cloudpayments sub-options ([694aecc](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/694aeccc3121116bf193b5766572de7472eb4016))
* remove executable bit from email_service.py ([372d628](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/372d628908294d905c37828219cac6aef7941151))
* remove forced white background from custom email template overrides ([cb61014](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/cb61014d9c5a89e3aeafb191f1b9826ca1cbf338))
* remove is_active_paid_subscription guard from admin deactivation ([1f664a9](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/1f664a9083d81bc4462c30bf0626a44b5a30f03e))
* remove subscription connection links from guest purchase emails ([9217352](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/9217352685189118620f1246bc7d7a4459883ed6))
* renewal cost estimate double-counts servers and traffic in tariff mode ([bfbefeb](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/bfbefeb1e20a191f604bbcbc79b14d8c6e4cd5bd))
* reset device limit to new tariff base on tariff switch ([aec01ce](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/aec01ce0d4a36da5ddd07b56ca4bd5de04735a0b))
* reset QR photo when returning to referral ([3ee108f](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/3ee108fce85962dde5bc6c80b3464278369da9f5))
* reset subscription for paid users, trial-to-paid tariff conversion, gift purchase MissingGreenlet ([e67b8e4](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/e67b8e448e5396ee6daa8c6278bb5a0b313dda74))
* resolve alembic migration failures on fresh database install ([bbd353f](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/bbd353ff38af57aa9a8f15c60bded3259a3e3e26))
* resolve concurrent AsyncSession bug and sanitize error responses ([4a5cacd](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/4a5cacda386e7fa60ad7b6393aa3372384bee128))
* resolve merge conflict with dev (accept calc_device_limit_on_tariff_switch) ([ba049ca](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/ba049ca017e004c25f8738f01b2d5f329a35bb5e))
* resolve MissingGreenlet in switch_tariff endpoint ([4d695be](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/4d695be7d51adda40fa72c00c349fb0e1ec4acd2))
* resolve NameError in YooKassa successful payment processing ([9d5329d](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/9d5329d9d1051eeaf77cfea4932557cdfbf21cc6))
* respect send_before_menu flag for pinned messages during new user registration ([20727b1](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/20727b1017457769feccccf83e99523c19026a7e))
* restore merge token on DB failure, fix partner_status priority ([9582758](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/9582758d1c85735c8ead8cbfeb56bbdae45288af))
* review findings — db.commit, isinstance guard, constants, ACTIVE check ([72b5305](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/72b5305b870ae9ecdb2672549b9c153dd8b3f7bc))
* review findings — exception chaining, redundant unquote, validator tightening ([467dea1](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/467dea1315fbaf8d09ccbba292cd0bcc60d9f3ab))
* second round review fixes for account merge ([64ee045](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/64ee0459e4e3d3fe87ad65387fcbcb147147ac1b))
* silence PARTICIPANT_ID_INVALID error in channel subscription check ([14dceaa](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/14dceaa39ff9faa1c9205483653014a1c5ac73fb))
* stars rate rounding + device/traffic purchase stats ([641ff86](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/641ff86bf6f1ac1f22146f4344beda05759869fc))
* strip newlines from subject substitution, fix subscription notification context ([c9ea2b1](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/c9ea2b15e9d670d6e1888c0396a145713ec749c0))
* sub-method enabled check, guest payment provider, silent FSM return ([603b9a1](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/603b9a1f4610a5b288d6fba78c98474c439529aa))
* **subscription:** remove stale extend promo state fields causing NameError ([20a6fa1](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/20a6fa1bcf362455623f43838f4ffaaf98b33e76))
* substitute context variables in email template overrides ([d52c87b](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/d52c87b2b752d3f432096318ac2ec4f9ad792929))
* substitute sample context in admin test email for template overrides ([351d714](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/351d714f2d4c200e8ab4263ff006ae33ec062d95))
* support {total_amount} placeholder in cart notification templates ([f4ab174](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/f4ab174d32be8b48470320c27c92e75fdabd6d58))
* support prefix-based gift code lookup for activation ([4fb72ae](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/4fb72ae6e3bc65d93ab84b594b4ff5b4856c5357))
* support Telegram OIDC id_token in account linking endpoint ([680c22c](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/680c22c0179253d24f7f89e115a283dac92f9a49))
* swap Caddy auth headers — api_key to Authorization, caddy_token to X-Api-Key ([038c34e](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/038c34e52a863d0c5c6993ea785587ba7e0bc61d))
* sync crypto link from happ.cryptoLink in webhook handlers ([0ceff44](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/0ceff44c30cf11466c4cbe51b520558c51c4af4a))
* sync squads to Remnawave panel on tariff purchase/switch ([c34fdd1](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/c34fdd10a0a22a85a4e29cbf44da2ac5d4a643b3))
* sync uv.lock version with pyproject.toml 3.23.1 ([8eb6a8c](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/8eb6a8c4606a0ea48e383c031ad83219fc8e062b))
* sync uv.lock version with pyproject.toml 3.23.1 ([bc52fd2](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/bc52fd27113f95a4154b1990142d46ae606fd2e0))
* transaction boundary and CORS in webapi ([6495384](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/6495384bcfd76c377971438f6c132f1404ea1f7d))
* treat empty icon_url as None in payment method validation ([ab981dc](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/ab981dce0d84bba3df5fc4366e39ba3ed0adeccd))
* undefined currency variable in RioPay payment creation ([5b33534](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/5b3353433bc524e3e51f2ae87d26bd162bd9f97b))
* UniqueViolation при мерже аккаунтов с общим OAuth/telegram/email ID ([1c89bd8](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/1c89bd8b2acfe49de2c97dd75446a037a54fded7))
* update promo group via M2M table so admin changes persist ([68bc8eb](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/68bc8eb57c792059d2be8a8fff6bba3254d3773d))
* use --frozen instead of --locked in Dockerfile to avoid version mismatch ([923b36a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/923b36a8b9caed5db1c147a5ef4c001f66f8170a))
* use 'kassa_ai' base model name for guest metadata patch ([182667e](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/182667ecb86f9bbbe87d640865dcbcaadf9e72f6))
* use base model name for KassaAI guest metadata patch ([b6d4373](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b6d43739337cd2e2cfd61ac33398eb6def5b28b6))
* use get_rendered_override for proper variable substitution in guest email overrides ([c165cca](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/c165cca3239c9a1249aae9e5e712f7e34fb01107))
* use information_schema for constraint existence checks in migrations ([fc65e2d](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/fc65e2de4c9c08e7df1886c458b53f7a05894934))
* use keyword args for Path.mkdir in asyncio.to_thread ([2879996](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/287999645506a49b6693a184757598e1cdceb4d8))
* use parsed HTML length for Telegram caption limit checks ([2649e12](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/2649e12f64b8f825a3db85b95da6a335b0f8eec6))
* use pg_class lookup for constraint existence checks in migrations ([ba335fe](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/ba335fe78430e26b9e2449dbbd6db209557698e0))
* use short TTL fallback in restore_merge_token on parse error ([0e8c61a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/0e8c61a7762ae796284144056c0cbdbcb53b6c7c))
* user deletion FK error + connected_squads None TypeError ([a5fbd74](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/a5fbd7400f828824c5baa520bdaf06023b4caf70))
* validate payment sub-option suffix and harden payment method handling ([5f01783](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/5f01783dcb63f2f8bc20fef935d74d7588273aea))
* безопасность и качество кода лендингов — 16 исправлений ([ef45095](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/ef450955e6b37d437dabac55da037f53ca1f75dc))
* гарантировать положительный доход от подписок и исправить общий доход ([93a55df](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/93a55df4c0ac099946d440ec79fefb24327ab0e1))
* дедупликация promocode_uses при мерже аккаунтов ([00a7db2](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/00a7db26905d53a9a978aaf6b97800ca3042b957))
* добавить create_transaction для 6 потоков оплаты с баланса ([374907b](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/374907b6078c483531061465983e23f281e841a2))
* добавить create_transaction и admin-уведомления для автопродлений ([9f35088](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/9f35088788c971cb757936dba7214abe54477af0))
* добавить ON DELETE CASCADE/SET NULL на все FK к users.id ([34c82c3](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/34c82c348829cf528154bd1e2f5d77006d7ed5da))
* добавить пробелы в формат тарифов (1000 ГБ / 2 📱) ([900be65](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/900be65617dd5bbc6ffdcc82bb5504e1a93ead95))
* добавлен импорт MAX_ALL_TIME_DAYS в admin_payments routes ([ad26832](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/ad268329be45bdd665ce4a6f142e9762a78e55b5))
* добавлены RioPay и SeverPay в REAL_PAYMENT_METHODS ([f967c29](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/f967c29bd7cfe8a66e7e0f492573bb7521fcda22))
* дубликаты системных ролей при переименовании и сброс permissions ([7a7fb71](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/7a7fb71bf535e2a501f0677747ba63ca0b27ede5))
* защита внешних сквадов от удаления при синхронизации серверов ([f84885c](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/f84885cc8aa0c9a70f916076e987284f1f9c3479))
* изолировать stored_amount от downstream consumers в create_transaction ([b87535a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b87535ad4842cbf1f99f6fc1e28b5932fa5e3baa))
* исправлен расчёт конверсии в статистике продаж ([3089c17](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/3089c1704b54323b4c2a151d40a5b395a427c658))
* исправления системы реферальных конкурсов ([6713b34](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/6713b3497854e73dddc212280d7bf12db818f38a))
* исправлены проблемы RioPay интеграции после ревью ([4abb8cb](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/4abb8cb1a3f21089697199261bcc37e6f6a5c623))
* кнопка «Назад» в тарифах ведёт в админ панель, а не в настройки ([04562fd](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/04562fd7e74de26776517549730819389b24a0d0))
* лог полного payload при ошибке PATCH /api/users для диагностики A039 ([8d7f0ee](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/8d7f0eea0fecd9e66bf199bd2c288e073f1354c0))
* миграция 0016 падает если FK constraint отсутствует в БД ([15fe45d](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/15fe45d11341001714599f8db963d182dc371aa3))
* миграция 0021 — drop server_default перед сменой типа на JSON ([3d3bb3b](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/3d3bb3badb55511960ed9b2a29ea67e0f0c3f26c))
* миграция Tribute webhook с deprecated user_id на trb_user_id ([9419941](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/94199413c283167edd829b337cf9bec0a5414a54))
* не пересылать activeInternalSquads в рутинных обновлениях RemnaWave (A039) ([4aaf0dd](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/4aaf0ddd25527ec23fa6a479ac3826d6b6266761))
* не пересылать externalSquadUuid в рутинных обновлениях RemnaWave ([3d68db0](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/3d68db0a51fac55640d44be784c832875ca2da17))
* передать явный диапазон дат для all_time_stats в дашборде ([968d147](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/968d14704610eed528bca28cbf295c1ba1644a5a))
* показывать кнопку покупки тарифа вместо ошибки для триальных подписок ([acfa4b3](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/acfa4b3c2ea96e74d93470085265df76ec50e1e6))
* показывать только активные провайдеры на странице /profile/accounts ([9d7a557](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/9d7a557ef0e294ce9920e9953bb1358656ff9b81))
* промокоды — конвертация триалов, race condition, savepoints ([7fb839a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/7fb839aef6234294b95064f9575c19d5a0c3f892))
* расширен лог PATCH /api/users payload для диагностики A039 ([db2f0c9](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/db2f0c93f2974410e744411fb9111c6de1f0f0be))
* реактивация DISABLED подписок при покупке трафика для LIMITED пользователей ([7d28f55](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/7d28f5516a52606280219cbea846fba431da80d2))
* реактивация DISABLED подписок при покупке устройств и в REST API ([b9e17be](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b9e17be8554a65eaf765a0b5b36fee062205c66f))
* режим «Контакт и тикеты» возвращает support_type='both' вместо 'tickets' ([2f33e55](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/2f33e5514469f2686c4b35e2105f4188a41d4145))
* реферальный бонус инвайтера — сумма вместо максимума, защита флага первого пополнения ([e1bcb1b](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/e1bcb1ba910ef3a79dec5fa974ae8e6c09494aa7))
* синхронизация версии pyproject.toml с main и обновление uv в Dockerfile ([b31a893](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b31a893b13b2db911e51298ceb0107419f9a4cb3))
* скрыть плашку верификации email при выключенной верификации ([4966e39](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/4966e39eb9b92967ef92c92ae434ca6cdea80c84))
* сохранение user_id до rollback чтобы избежать MissingGreenlet при lazy load ([3f8e899](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/3f8e8993b2949b5a5e04b1d8a468ef7dc1170e08))
* убрана отправка externalSquadUuid=null в RemnaWave API и исправлен ложный лог синхронизации рулетки ([f80912e](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/f80912e444ab5706c809e689ca5ed2a38da118d0))
* убрать WITHDRAWAL из автонегации, добавить abs() в агрегации, исправить all_time_stats ([6da61d7](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/6da61d79510f7e05310f3cc020515b4dd0b3eb34))
* убрать избыточный минус в amount_kopeks для create_transaction ([849b3a7](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/849b3a7034f2291db40e049c12e1b7c71b58bab1))
* уведомление об истечении подписки теперь учитывает autopay_enabled пользователя ([c0b282a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/c0b282a189a2b761c68fc70886edd91d9c807ff6))
* устранена отправка externalSquadUuid=null в RemnaWave API (A039) и исправлен reduce_devices ([e453521](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/e4535210982351413cb82483000fe441e7b7300a))
* устранение race condition при покупке устройств через re-lock после коммита ([a7a18dd](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/a7a18dd0d1d59c64f7e4dd3ddc1b8cec47198077))
* устранение race conditions и атомарность платёжной системы ([4984f20](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/4984f20e8fb030ee338723d797d51aee21f67ca8))
* устранение каскадного PendingRollbackError при восстановлении бэкапа ([8259278](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/82592784d0da8b8718f3b3aa34076af59ad2a878))


### Performance

* add covering indexes for referral network queries ([b5471b7](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b5471b7720213c217fc452dc1234a7d3c53447d5))


### Refactoring

* add typed breakdowns + module-level singleton to PricingEngine ([b551def](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b551def3402e2bf762406fb0b374360958231bb3))
* deduplicate gift activation in start.py ([769d3a0](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/769d3a0b309fb6be1c3175cd66a0df7cb6e2fb67))
* deduplicate KassaAI handlers with config dict and shared helpers ([e4bb043](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/e4bb0430fb9cc4f55013767ceda6d1c214bd80a6))
* extract shared formatting helpers into app/utils/formatting.py ([5e9a462](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/5e9a462261e46ee649de481266a821fd6793bf2e))
* extract shared OAuth linking logic, add Literal types for providers ([f7caf0d](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/f7caf0de709ca6a46283f0b1928e34f8908f2c93))
* make finalize() accept both old and new pricing types ([3efa24b](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/3efa24bab3a2bd1d31103b134e502c10af8e41e1))
* migrate admin user price calculation to PricingEngine ([49c0f3f](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/49c0f3fc10d27092961601cf7f6a780fb56885fa))
* migrate all callers to pricing_engine singleton + fix miniapp discount ([e24b911](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/e24b911283bf4cbee7b18d3e49c935217e4a2863))
* migrate bot renewal display to PricingEngine ([ce82c2c](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/ce82c2c00988542ac73dc9d2e811711ea9cefebe))
* migrate bot renewal execute to PricingEngine ([acf27a1](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/acf27a102308d38676b2ccaef78016b56a80935d))
* migrate cabinet renewal display + execute to PricingEngine ([28fc36d](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/28fc36dca41b626430baf823274561269023ac59))
* migrate cart auto-purchase to PricingEngine (fresh calc) ([bd2e93a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/bd2e93a6a5076341b104f7dba2b7fc5fdb587e66))
* migrate menu.py renewal pricing to PricingEngine ([652b6da](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/652b6dabde014d19075f13198dd06e5fb8bef380))
* migrate miniapp renewal display + execute to PricingEngine ([cb43aca](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/cb43acab3194bbf9b6e2c04ca0254ba5b2571b2d))
* migrate recurrent and monitoring services to PricingEngine ([978f68e](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/978f68e7be42b0faf92d9ac5bc0bbaa2022ac95b))
* migrate remaining callers to PricingEngine + cleanup dead CRUD ([75dbd2b](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/75dbd2b4fcc8ab14ac44d915bf55b10406544bb1))
* migrate try_auto_extend_expired to PricingEngine ([e6ebc67](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/e6ebc6722d826d291156e6bff3bf86000b32b783))
* move KASSA_AI_SUB_METHODS to service layer, add early enabled checks ([cda2392](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/cda239241122ae1dd02a252b3eadc47453c0c48b))
* move squad propagation to service layer with parallel Remnawave sync ([79161ea](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/79161eaae4d67c82c45b6ea3654c0b15c8b785a4))
* remove dead pricing code and fix miniapp classic mode ([c9a9816](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/c9a9816daa15a4534a3990822543eeefe1a1631b))
* remove estimated price from balance, simplify server sync, fix HTML injection ([a798f11](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/a798f1143eebf52e18254bddd610f7f14a0c4056))
* remove quick amount buttons feature entirely ([136f29c](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/136f29c1eb63778b2b329ed5bf72ab06a4531d0b))
* rename GIFTCODE_ start parameter prefix to GIFT_ ([42b6c80](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/42b6c80a48ad0100d5ddbbe99a096ebb7b292f08))
* unify first-purchase discount algorithm with PricingEngine ([fe4e6ac](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/fe4e6acb5391d0797ea01281eeb2e2ea59a0070f))
* централизация всех расчётов цен в PricingEngine ([8d3cd50](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/8d3cd500980f4f640cb1ba493150f1f20e8bd58c))


### Documentation

* add bot preview screenshot to README ([d7931a2](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/d7931a2afaf272aae74453f2bb6d493593895f67))
* add cabinet preview screenshot to README ([b032c8f](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/b032c8f35435ddd592df04d6352097580f5e9837))
* add icons and list all 14+1 payment providers ([1306c24](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/1306c24fa36fd3e812c5bec551a0aca450ca7d2c))
* add Redis to tech stack ([c14d7ab](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/c14d7ab0af2e5dd4f35213b323a97eedcc99af0e))
* add Redis to tech stack ([e12cc9f](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/e12cc9f248764104d538db1daaede9ddd8b77b2d))
* add WATA partnership block to payments section ([31bdf8a](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/31bdf8a0aeba53fcec40358d0a38b8480130a346))
* increase logo size to 800px ([22e7f15](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/22e7f150b30c35b0419e7923e94c5ebc92c4b61a))
* redesign README — concise feature showcase, link to docs ([38deb70](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/38deb70f8118d371e36ac92a4417bdb543635fc9))
* replace header logo with new artwork ([6888822](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/688882237fe3019bb78d5e1d7ad54faf4cd69c09))
* WATA partnership block with logo and table card ([8d5a002](https://github.com/vorgoron/remnawave-bedolaga-telegram-bot/commit/8d5a0029964ba52b40e03ebfe8ab6f4146d3aca9))
